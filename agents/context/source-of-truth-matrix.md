...
| --- | --- | --- | --- | --- |
| Compose deployment stack | `docker-compose.yml` | `README.md`, `Docs/DEPLOYMENT.md`, `Docs/OPERATIONS.md` | `agents/context/docker-compose-stack.md`, `agents/rules/service-boundaries.md` | `make verify`, `docker compose --env-file env.example config` when available |
...
| Storage model | `docker-compose.yml`, `env.example` | `Docs/STORAGE.md`, `Docs/DEPLOYMENT.md` | `agents/context/storage-and-volumes.md`, `agents/rules/service-boundaries.md` | `make verify` |
